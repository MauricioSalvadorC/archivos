        ...
        && y1>pic+rectangulos[i].y*separa && y1<pic+rectangulos[i].y*separa+separa){                    
            ...
            for(let j=0; j<colums; j++){
                if(px < pif+j*separa+separa/2){
                    ...
                    ctx.fillRect(grisx, pic-8, rectangulos[i].n*separa, filas*separa);
                    break;
                }
            }
        }
            ...
            for(let i=0; i<rectangulos.length; i++) {
                if(rectangulos[i].y==j && rectangulos[i].x==cont){
                    ...
                    && y1>pic+rectangulos[i].y*separa && y1<pic+rectangulos[i].y*separa+separa){                    
                        ...
                        pintarFigura([px, rectangulos[i].py, px+8, rectangulos[i].py-8, px+8, rectangulos[i].py], rectangulos[i].color);
                        pintarFigura([px+rectangulos[i].n*separa, rectangulos[i].py+separa, px+8+rectangulos[i].n*separa, rectangulos[i].py-8+separa, px+rectangulos[i].n*separa, rectangulos[i].py+separa-8], rectangulos[i].color);
                        ctx.lineWidth = 3;
                        ctx.strokeStyle= "black";

                        ctx.fillStyle= rectangulos[i].color;
                        ctx.fillRect(px+8, rectangulos[i].py-8, rectangulos[i].n*separa, separa);
                        ...
                        pintarLinea(px, rectangulos[i].py, px+8, rectangulos[i].py-8,"black", 3);
                        pintarLinea(px+8+rectangulos[i].n*separa, rectangulos[i].py-8, px+8, rectangulos[i].py-8,"black", 3);
                        pintarLinea(px+8+rectangulos[i].n*separa, rectangulos[i].py-8, px+8+rectangulos[i].n*separa, rectangulos[i].py-8+separa,"black", 3);
                        pintarLinea(px+8+rectangulos[i].n*separa-8, rectangulos[i].py+separa, px+8+rectangulos[i].n*separa, rectangulos[i].py-8+separa,"black", 3);
                        pintarLinea(px+rectangulos[i].n*separa, rectangulos[i].py, px+rectangulos[i].n*separa+8, rectangulos[i].py-8,"black", 3);
...
function pintarLineasH() {
    for(let i=0; i<=filas; i++){
        pintarLinea(pif+8, pic+i*separa-8, pif+colums*separa+8, pic+i*separa-8,"#BAB6B6", 2)
    }
}
function pintarLineasV() {
    for(let i=0; i<=colums; i++){
        pintarLinea(pif+i*separa+8, pic-8, pif+i*separa+8, pic+filas*separa-8,"#BAB6B6", 2)
    }
}
...
function pintar3d(rectangulo) {
    ctx.beginPath();
    pintarFigura([pif+rectangulo.x*separa, rectangulo.py, pif+rectangulo.x*separa+8, rectangulo.py-8, pif+rectangulo.x*separa+8, rectangulo.py], rectangulo.color);
    pintarFigura([pif+rectangulo.x*separa+rectangulo.n*separa, rectangulo.py+separa, pif+rectangulo.x*separa+8+rectangulo.n*separa, rectangulo.py-8+separa, pif+rectangulo.x*separa+rectangulo.n*separa, rectangulo.py+separa-8], rectangulo.color);
    ctx.lineWidth = 3;
    ctx.strokeStyle= "black";

    ctx.fillStyle= rectangulo.color;
    ctx.fillRect(pif+rectangulo.x*separa+8, rectangulo.py-8, rectangulo.n*separa, separa);
    // ctx.strokeRect(pif+rectangulo.x*separa+1, rectangulo.py+8, rectangulo.n*separa-8, separa-8);
    pintarLinea(pif+rectangulo.x*separa, rectangulo.py, pif+rectangulo.x*separa+8, rectangulo.py-8,"black", 3);
    pintarLinea(pif+rectangulo.x*separa+8+rectangulo.n*separa, rectangulo.py-8, pif+rectangulo.x*separa+8, rectangulo.py-8,"black", 3);
    pintarLinea(pif+rectangulo.x*separa+8+rectangulo.n*separa, rectangulo.py-8, pif+rectangulo.x*separa+8+rectangulo.n*separa, rectangulo.py-8+separa,"black", 3);
    pintarLinea(pif+rectangulo.x*separa+8+rectangulo.n*separa-8, rectangulo.py+separa, pif+rectangulo.x*separa+8+rectangulo.n*separa, rectangulo.py-8+separa,"black", 3);
    pintarLinea(pif+rectangulo.x*separa+rectangulo.n*separa, rectangulo.py, pif+rectangulo.x*separa+rectangulo.n*separa+8, rectangulo.py-8,"black", 3);
}
...
canvas.addEventListener("mouseup", (evt)=>{
    ...
    if(select==true && rectangulos[posSelect].x != (grisx-pif-8)/separa){
